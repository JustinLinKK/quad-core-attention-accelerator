...
# Read RTL
analyze -format verilog -lib WORK cdc_fifo.v
analyze -format verilog -lib WORK fifo_storage16.v
...
# Write Out Design - Hierarchical netlist
current_design $top_module
...
# Check all sub-designs for unmapped logic
