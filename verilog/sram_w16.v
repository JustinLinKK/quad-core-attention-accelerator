...
module sram_w16 (CLK, D, Q, CEN, WEN, A);
  ...
  initial begin
    if (init_zero) begin
      memory0  = {sram_bit{1'b0}};
      memory1  = {sram_bit{1'b0}};
      memory2  = {sram_bit{1'b0}};
      memory3  = {sram_bit{1'b0}};
      memory4  = {sram_bit{1'b0}};
      memory5  = {sram_bit{1'b0}};
      memory6  = {sram_bit{1'b0}};
      memory7  = {sram_bit{1'b0}};
      memory8  = {sram_bit{1'b0}};
      memory9  = {sram_bit{1'b0}};
      memory10 = {sram_bit{1'b0}};
      memory11 = {sram_bit{1'b0}};
      memory12 = {sram_bit{1'b0}};
      memory13 = {sram_bit{1'b0}};
      memory14 = {sram_bit{1'b0}};
      memory15 = {sram_bit{1'b0}};
      Q = {sram_bit{1'b0}};
    end
  end
